...
import { FileText, Bell, Calendar, Eye, Cake } from 'lucide-react'
...
export function EmployeeDashboard() {
    ...
    const { data: birthdayUsers = [] } = useSWR<User[]>('/api/birthdays', fetcher)
                                    ...
                                    {upcomingHolidays.map((holiday) => (
                                        <CarouselItem key={holiday.id}>
                                            <div className="p-1 rounded-lg bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 animate-gradient-xy h-full">
                                                <div className="bg-card rounded-md p-4 h-full relative overflow-hidden group flex flex-col justify-between">
                                                    ...
                                                    <div>
                                                        <h4 className="font-bold text-lg mb-2 bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-400 dark:to-purple-400 relative z-10">
                                                            {holiday.name}
                                                        </h4>
                                                        <p className="text-sm text-foreground/80 line-clamp-3 mb-4 relative z-10 opacity-0 select-none hidden md:block">
                                                            &nbsp;
                                                        </p>
                                                    </div>
