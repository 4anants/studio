  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <DialogFooter>
          <Button onClick={handleAdd} className="rounded-xl bg-blue-600 hover:bg-blue-700 text-white shadow-lg transition-all transform hover:scale-105 border-0 font-medium px-4">Add Department</Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
  );
