...
export const IdCard = forwardRef<HTMLDivElement, { employee: User }>(({ employee }, ref) => {
    ...
    const companyAddress = (employee.location && locations[employee.location as keyof typeof locations]) ? locations[employee.location as keyof typeof locations] : 'N/A';
