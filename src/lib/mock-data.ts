...
export const users: User[] = [
  { id: 'sadmin', name: 'Super Admin', email: 'sadmin@internal.local', password: 'Supper@321..', avatar: 'sadmin', status: 'active', role: 'admin', designation: 'Super Administrator', department: 'Information & Technology' },
